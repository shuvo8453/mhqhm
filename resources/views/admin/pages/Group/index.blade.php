	...
	<div class="container-fluid p-0">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="add_Label">Add Group</h5>
		...
		<div class="modal fade" id="edit" tabindex="-1" aria-labelledby="edit_Label" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="edit_Label">Edit Group</h5>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
...
@section('script')
	<script>
        ...
        $(document).on('submit','#addForm',function(e){
            ...
            store_handler( "{{route('Group.store')}}" ,formData );
        });
